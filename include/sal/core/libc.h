...
#define _SAL_LIBC_H
/*
 * Note: inclusion of <stdio.h> is required due to the references
 * to size_t. The definition of C standard library (libc) indicates that
 * stdio.h is a required header file to be included by libc users.
 */
#include <stdio.h>
